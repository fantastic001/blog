...
u programskoj jeziku C kao i da taj napisani kod znate da kompajlirate upotrebom GCC kompajlera. 
...
Šta se sad desilo? Pa kako se naša linija izvršila, promenljivoj f je dodeljen rezultat funkcije fact. Da bismo odštampali vrednost promenljive f, koristimo komandu print ili skraćeno p:
